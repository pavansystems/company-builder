...
export default function MonitoringError({ error, reset }: ErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 text-center">
      ...
      <h2 className="text-xl font-bold text-slate-900 mb-2">Monitoring failed to load</h2>
      <p className="text-sm text-slate-500 max-w-sm mb-1">
        {error.message || 'An unexpected error occurred while loading agent monitoring.'}
      </p>
      {error.digest && (
