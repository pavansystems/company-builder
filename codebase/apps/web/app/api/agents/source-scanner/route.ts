...
import { SourceScannerAgent } from '@company-builder/agents';
...
export async function POST(request: NextRequest) {
  ...
  const agent = new SourceScannerAgent({
    name: 'source-scanner',
    description:
      'Scans and normalizes content from technology, startup, and market intelligence sources for Phase 0 Discovery.',
  ...
  try {
    ...
    console.error('[source-scanner] Error:', error);
