...
import { ConceptScorerAgent } from '@company-builder/agents';
...
export async function POST(request: NextRequest) {
  ...
  const agent = new ConceptScorerAgent({
    name: 'concept-scorer',
    description:
      'Scores startup concepts on five dimensions (innovation, market fit, agent leverage, feasibility, differentiation) to produce a prioritized ranking.',
