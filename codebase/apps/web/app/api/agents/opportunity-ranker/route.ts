...
import { OpportunityRankerAgent } from '@company-builder/agents';
...
export async function POST(request: NextRequest) {
  ...
  const agent = new OpportunityRankerAgent({
    name: 'opportunity-ranker',
    description:
      'Scores market opportunities across five dimensions (market size, signal convergence, agent readiness, competitive density, timing confidence) to produce a composite ranking.',
  ...
  try {
    ...
    console.error('[opportunity-ranker] Error:', error);
