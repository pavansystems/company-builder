...
import { LandscapeAnalystAgent } from '@company-builder/agents';
...
export async function POST(request: NextRequest) {
  ...
  const agent = new LandscapeAnalystAgent({
    ...
    description:
      'Analyzes the competitive landscape for a market opportunity to identify incumbents, emerging players, and agent disruption angles.',
  ...
  try {
    ...
    console.error('[landscape-analyst] Error:', error);
