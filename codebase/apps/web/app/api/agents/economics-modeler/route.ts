...
import { EconomicsModelerAgent } from '@company-builder/agents';
...
export async function POST(request: NextRequest) {
  ...
  const agent = new EconomicsModelerAgent({
    name: 'economics-modeler',
    description:
      'Constructs defensible unit economics including CAC, LTV, gross margin, and breakeven projections with bear/base/bull scenario analysis.',
  ...
  try {
    ...
    console.error('[economics-modeler] Error:', error);
