...
import { ConceptGeneratorAgent } from '@company-builder/agents';
...
const log = logger.child({ service: 'api', route: 'concept-generator' });
...
export async function POST(request: NextRequest) {
  ...
  const agent = new ConceptGeneratorAgent({
    name: 'concept-generator',
    description:
      'Generates 5–8 distinct agent-first startup concepts grounded in validated pain points and landscape analysis.',
