...
import { MarketClassifierAgent } from '@company-builder/agents';
...
export async function POST(request: NextRequest) {
  ...
  const agent = new MarketClassifierAgent({
    name: 'market-classifier',
    description:
      'Groups detected signals into specific market opportunity candidates, assessing agent-readiness and market sizing.',
  ...
  try {
    ...
    console.error('[market-classifier] Error:', error);
